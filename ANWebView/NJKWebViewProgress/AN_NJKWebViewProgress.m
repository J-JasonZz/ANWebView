...
const float AN_NJKInitialProgressValue = 0.1f;
const float AN_NJKInteractiveProgressValue = 0.5f;
const float AN_NJKFinalProgressValue = 0.9f;

@implementation AN_NJKWebViewProgress
{
...
- (void)startProgress
{
    if (_progress < AN_NJKInitialProgressValue) {
        [self setProgress:AN_NJKInitialProgressValue];
    }
}
...
- (void)incrementProgress
{
    ...
    float maxProgress = _interactive ? AN_NJKFinalProgressValue : AN_NJKInteractiveProgressValue;
